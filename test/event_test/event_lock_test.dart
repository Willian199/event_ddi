...
void eventLockTest() {
  group('DDI Event Lock tests', () {
    ...
    test('Running multiples event with lock', () async {
      ...
      expect(eventOrder[3], 1);
      expect(eventOrder[4], 14);
      expect(eventOrder[5], 15);
      expect(eventOrder[6], 2);
      expect(eventOrder[7], 3);
      expect(eventOrder[8], 4);
      expect(eventOrder[9], 5);
    ...
    test('Running multiples async event with lock', () async {
      expect(ddiEvent.isRegistered(qualifier: 'multiple_events'), isFalse);
      ...
      for (int i = 1; i <= 5; i++) {
        ddiEvent.fireWait(i, qualifier: 'multiple_events');
      }
